...
if ($null -ne $rgCommand) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        throw "Prohibited Lean placeholder or escape found in Navier-Stokes A+ audit surface."
    }
...
Write-Host "No live axiom/sorry/admit/unsafe declarations found in Navier-Stokes A+ audit surface."
...
if ($LASTEXITCODE -ne 0) {
    throw "Navier-Stokes inherited surface axiom check failed."
}
...
Write-Host "Navier-Stokes A+ audit checkpoint passed."
